...
//Cloudveil start
func fetchUnreadDataWithAcccount(buildConfig: BuildConfig, proxyConnection: AccountProxyConnection?, account: StoredAccountInfo, datacenterId: Int32, completion: @escaping (State?) -> Void) -> () -> Void {
