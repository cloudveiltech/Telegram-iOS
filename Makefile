...
export BUCK=buck
export DEAD_CODE_STRIPPING=true
...
export API_ID=150211
export API_HASH=24cc1afc4d8370058fbfde1aaa4b1ab8
export BUNDLE_ID=com.cloudveil.CloudVeilMessenger
export IS_INTERNAL_BUILD=false
export IS_APPSTORE_BUILD=true
export APPSTORE_ID=
export APP_SPECIFIC_URL_SCHEME=tgcv
