...
class BuildConfiguration:
    def __init__(self,
        ...
        self.cloudveil_shiplogs = cloudveil_shiplogs
    ...
    def write_to_variables_file(self, bazel_path, use_xcode_managed_codesigning, aps_environment, path):
        ...
        string += 'cloudveil_shiplogs = {}\n'.format(self.cloudveil_shiplogs)
...
def build_configuration_from_json(path):
    ...
    with open(path) as file:
        ...
        return BuildConfiguration(
            ...
            cloudveil_shiplogs=configuration_dict['cloudveil_shiplogs']
        )
