...
#ifndef CLOUDVEILSECURITYMANAGER_SWIFT_H
#define CLOUDVEILSECURITYMANAGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CloudVeilSecurityManager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24CloudVeilSecurityManager5TGRow")
@interface TGRow : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC24CloudVeilSecurityManager17TGSettingsRequest")
...
SWIFT_CLASS("_TtC24CloudVeilSecurityManager16TGUserController")
